...
document.getElementById("sketch_to_be_drawn").innerHTML = "Sketch to be drawn is : "+sketch;
document.getElementById("score").innerHTML = "Score :"+score;

setInterval(timer, 100);
setInterval(results, 1000);
setInterval(preload, 1000);
setInterval(check_sketch,9000);
...
console.log("The time is: " + timer_counter);
